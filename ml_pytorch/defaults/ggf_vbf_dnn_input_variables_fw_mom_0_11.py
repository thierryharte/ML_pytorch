...
dnn_input_variables = OrderedDict(
    {
        ...
        # Fox-Wolfram moments
        "FW_H0_W_T": ["events", "FW_H0_W_T"],
        "FW_H0_W_s": ["events", "FW_H0_W_s"],
        "FW_H0_W_z": ["events", "FW_H0_W_z"],
        "FW_H1_W_T": ["events", "FW_H1_W_T"],
        "FW_H1_W_s": ["events", "FW_H1_W_s"],
        "FW_H1_W_z": ["events", "FW_H1_W_z"],
        "FW_H2_W_T": ["events", "FW_H2_W_T"],
        "FW_H2_W_s": ["events", "FW_H2_W_s"],
        "FW_H2_W_z": ["events", "FW_H2_W_z"],
        "FW_H3_W_T": ["events", "FW_H3_W_T"],
        "FW_H3_W_s": ["events", "FW_H3_W_s"],
        "FW_H3_W_z": ["events", "FW_H3_W_z"],
        "FW_H4_W_T": ["events", "FW_H4_W_T"],
        "FW_H4_W_s": ["events", "FW_H4_W_s"],
        "FW_H4_W_z": ["events", "FW_H4_W_z"],
        "FW_H5_W_T": ["events", "FW_H5_W_T"],
        "FW_H5_W_s": ["events", "FW_H5_W_s"],
        "FW_H5_W_z": ["events", "FW_H5_W_z"],
        "FW_H6_W_T": ["events", "FW_H6_W_T"],
        "FW_H6_W_s": ["events", "FW_H6_W_s"],
        "FW_H6_W_z": ["events", "FW_H6_W_z"],
        "FW_H7_W_T": ["events", "FW_H7_W_T"],
        "FW_H7_W_s": ["events", "FW_H7_W_s"],
        "FW_H7_W_z": ["events", "FW_H7_W_z"],
        "FW_H8_W_T": ["events", "FW_H8_W_T"],
        "FW_H8_W_s": ["events", "FW_H8_W_s"],
        "FW_H8_W_z": ["events", "FW_H8_W_z"],
        "FW_H9_W_T": ["events", "FW_H9_W_T"],
        "FW_H9_W_s": ["events", "FW_H9_W_s"],
        "FW_H9_W_z": ["events", "FW_H9_W_z"],
        "FW_H10_W_T": ["events", "FW_H10_W_T"],
        "FW_H10_W_s": ["events", "FW_H10_W_s"],
        "FW_H10_W_z": ["events", "FW_H10_W_z"],
        "FW_H11_W_T": ["events", "FW_H11_W_T"],
        "FW_H11_W_s": ["events", "FW_H11_W_s"],
        "FW_H11_W_z": ["events", "FW_H11_W_z"],
        # HH system
